...
public class GenericSort {
    ...
    public static class Person implements Comparable<Person> {
        ...
        public int compareTo(Person other) {
            ...
            // Forskjellig etternavn, returnerer sammenlikning av etternavnet (last_name_compare)
            else {
    ...
    public static void main(String[] args) {
        ...
        // class? int? double? plain old datatypes. IKKE KLASSER
    ...
    void sort(T[] values) {
        ...
        // Vi skal sortere n-1 tall, siden siste tall er alltid sortert riktig
    ...
    public static void pass_by_reference(int[] value) {
        ...
        int my_value = 5;
        test(my_value);
        System.out.println("Versjon 1: " + my_value);
        // Forventer: 5: 29%, 7: 64%, vet ikke: 7%


        int[] my_value_array = {5};
        test_array(my_value_array);
        System.out.println("Versjon 2: " + Arrays.toString(my_value_array));
        // Forventer: 5: 17%, 9: 79%, vet ikke: 4%
    }
    ...
    // Pass by reference: vi sender en peker til det faktiske objektet.
    public static void test_array(int[] value) {
