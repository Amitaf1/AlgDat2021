public class TournamentTree {
     ...
     *
     * A Java object is actually just a pointer to a memory address
     * where the objects data lies.
     *
     * This means that we can have an instantiated object of Node,
     * Node root = new Node('r');
     *
     * This node, root, then is a pointer to a memory location.
     *
     * At this location, we will then find
     * the value 'r', and two more pointers:
    ...
    public static class Node {
         ...
         * later in the course.
         * The print function ends up printing all
